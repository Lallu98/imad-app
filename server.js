...
var config = {
    user: 'lalithalakshmiramesh88',
    database: 'lalithalakshmiramesh88',
...
var articles = {
    'article-one' : {
    title: 'Article One | Lalithalakshmi R',
    heading: 'Article One',
    date: 'Aug 15, 2017',
    content: `
        <p>
    ...
    'article-three' : {
    title: 'Article Three | Lalithalakshmi R',
...
app.post('create-user',function(req,res) {
   //username,password
   //JSON
   //{"username":"Lalithalakshmi","password":"password"}
